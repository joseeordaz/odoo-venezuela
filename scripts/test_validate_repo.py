...
class TestValidationWorkflow(unittest.TestCase):
    def test_checks_patch_whitespace_against_upstream(self):
        workflow = (
        ...
        self.assertIn("19.0:refs/remotes/upstream/19.0", workflow)
        self.assertIn("git diff --check upstream/19.0...HEAD", workflow)
